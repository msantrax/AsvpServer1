...
def c_pressure(value,
    ...
    if mode_from != mode_to:
        ...
        value = value * \
                asvp.classes.adsorbate.Adsorbate.find(adsorbate_name).saturation_pressure(
                temp, unit=unit) ** sign
...
def c_loading(value,
    ...
    if basis_from != basis_to:
        ...
        if basis_from == 'mass':
            if basis_to == 'volume':
                constant = asvp.classes.adsorbate.Adsorbate.find(
            ...
            if basis_to == 'mass':
                ...
                adsorbate = asvp.classes.adsorbate.Adsorbate.find(
                    adsorbate_name)
...
def c_adsorbent(value,
    ...
    if basis_from != basis_to:
        ...
        if basis_from == 'mass':
            if basis_to == 'volume':
                constant = asvp.classes.material.Material.find(
            ...
            if basis_to == 'mass':
                ...
                material = asvp.classes.material.Material.find(
