...
def mesopore_size_distribution(isotherm, psd_model, pore_geometry='cylinder',
    ...
    See Also
    --------
    asvp.calculations.psd_mesoporous.psd_bjh : the BJH or Barrett, Joyner and Halenda method
    asvp.calculations.psd_mesoporous.psd_dollimore_heal : the DH or Dollimore-Heal method
...
def micropore_size_distribution(isotherm, psd_model, pore_geometry='slit',
    ...
    See Also
    --------
    asvp.calculations.psd_microporous.psd_horvath_kawazoe : the HK, of Horvath-Kawazoe method
...
def dft_size_distribution(isotherm, kernel_path, verbose=False, bspline_order=2, **model_parameters):
    ...
    *Limitations*
    ...
    See Also
    --------
    asvp.calculations.psd_dft.psd_dft_kernel_fit : fitting of isotherm data with a DFT kernel
