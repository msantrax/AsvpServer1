...
#   Instantiation and classmethods
    ...
    def __init__(self,
        ...
        if self.adsorbate.lower() not in asvp.ADSORBATE_NAME_LIST:
            ...
            self.adsorbate = asvp.Adsorbate.find(self.adsorbate).name
    ...
    def pretty_print(self, show=True, **plot_iso_args):
        ...
        out = ""
        out = out.join("<h1>Teste de <b>escrita</b> no canvas </hi>")
    ...
    def __str__(self):
        ...
        # Required
        string += ("Material 1: " + str(self.material_name) + '\n')
