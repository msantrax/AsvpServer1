...
#   Instantiation and classmethods
    ...
    def __init__(self,
        ...
        if isotherm_data is not None:
            ...
            if not all([a in isotherm_data.columns for a in columns]):
                raise ParameterError("Could not find some specified columns in the adsorption DataFrame")
        ...
        self.l_interpolator = isotherm_interpolator('loading', None, None,interp_branch=None)

        #: The internal interpolator for pressure given loading.
        self.p_interpolator = isotherm_interpolator('pressure', None, None,interp_branch=None)
    ...
    def from_json(cls, json_string, **isotherm_parameters):
        ...
        """
        return asvp.isotherm_from_json(json_string, **isotherm_parameters)
    ...
    def convert_pressure(self, mode_to=None, unit_to=None, verbose=False):
        ...
        if mode_to == self.pressure_mode and unit_to == self.pressure_unit:
            ...
            self.p_interpolator = isotherm_interpolator('pressure',
                                                        self.loading(branch=interp_branch),
                                                        self.pressure(branch=interp_branch),
...
#   Info function
    ...
    def print_info(self, show=True, **plot_iso_args):
        ...
        ----------------
        plot_iso_args : dict
            options to be passed to asvp.plot_iso()
        ...
        plot_dict = dict(
            ...
            absorbent_basis = self.adsorbent_basis,
