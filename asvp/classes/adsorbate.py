...
class Adsorbate():
    ...
    def find(cls, adsorbate_name):
        ...
        adsorbate = None
        for ads in asvp.ADSORBATE_LIST:
        ...
        if adsorbate is None:
            raise ParameterError(
                ...
                "First populate asvp.ADSORBATE_LIST "
    ...
    def backend(self):
        ...
        """
        if not self._backend_mode or self._backend_mode != asvp.COOLPROP_BACKEND:
            self._backend_mode = asvp.COOLPROP_BACKEND
            self._state = CoolProp.AbstractState(
                asvp.COOLPROP_BACKEND, self.backend_name())
